...
if("FALSE" STREQUAL "TRUE")
  ...
  set(ball_chaser_DEVEL_PREFIX /home/robond/catkin_ws/devel_isolated/ball_chaser)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/robond/catkin_ws/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/catkin_ws/install_isolated/lib;/opt/ros/kinetic/lib)
